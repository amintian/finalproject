...
@section('title')
{{$settings->site_name}} || Under Construction
@endsection

@section('content')
    <section id="wsus__under_construction">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <img src="{{ asset('public/frontend/images/under.png') }}" alt="Halaman Sedang Dikembangkan">
                </div>
            </div>
        </div>
    </section>
